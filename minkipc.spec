...
%build
%cmake -DSYSTEMD_UNIT_DIR=/usr/lib/systemd/system -DUDEV_DIR=/usr/lib/udev/rules.d -DBUILD_UNITTEST=TRUE -DDISTRO_USER=securemsm -DDISTRO_GROUP=securemsm -DBUILD_PKCS11=OFF
%cmake_build
